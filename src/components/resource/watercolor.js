			...
			<div className='container'>
				<div className='columns'>
					<div className='column is-full'>
						<h1 className="main-title">Watercolors</h1>
						<h1 className='title is-3 mb-2 mt-5'>Intro to Watercolors</h1>
						<p className='subtitle is-5 mt-2'>Watercolor (American English) or watercolour (British English; see spelling differences), also aquarelle (French: [akaʁɛl]; from Italian diminutive of Latin aqua "water"),[1] is a painting method in which the paints are made of pigments suspended in a water-based solution. Watercolor refers to both the medium and the resulting artwork. Aquarelles painted with water-soluble colored ink instead of modern water colors are called aquarellum atramento (Latin for "aquarelle made with ink") by experts. However, this term has now tended to pass out of use.[2][3]
						...
						American artists in the early 19th century seemed to regard watercolor primarily as a sketching tool in preparation for the "finished" work in oil or engraving.[6] </p>

						<div><h1 className='title is-3 mb-2 mt-5'>Tips and Tricks from the Masters</h1></div>

						<p className='subtitle is-5'>Pepe Silvia has been painting with watercolor for over 30 years and has his work displayed in many famous museums along with houses of celebrities.
